...
<html lang="en">
    ...
    <body>
        ...
        <!---------------- CONTEÚDO --------------->
        <div class="container regrasNorma">
            <article class=row>
                <div class="col-xs-6 col-sm-9 col-md-12 col-lg-12 mt-2 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
                    ...
                    <div class="text-justify">
                        ...
                        <ul>
                            ...
                            <li><p>Prática, indução ou incitação de preconceito quanto à origem, raça, etnia, sexo, orientação sexual, cor, idade, crença religiosa ou qualquer outra forma de discriminação;</p></li>
                            <li><p>Material calunioso, abusivo ou que invada a privacidade de alguém;</p></li>
                            <li><p>Imagens e/ou linguagem obscena ou pornográfica;</p></li>
                            <li><p> Afirmações injuriosas ou difamatórias;</p></li>
                            <li><p>Informação sobre atividades ilegais e incitação ao crime;</p></li>
                            <li><p>Material protegido por direitos autorais, nem publicar fotos ou textos sem autorização do autor ou de seu representante legal, publicar fotos sem autorização dos fotografados e distribuir arquivos de som sem autorização de pessoas ou empresas responsáveis;</p></li>
                            <li><p>Informação relativa à pirataria de material protegido pelas leis de direitos autorais e propriedade;</p></li>
                            <li><p>Divulgar como próprio ou sem a devida autorização nomes, contatos e demais informações de terceiros;</p></li>
                            <li><p>Propaganda eleitoral;</p></li>
                            <li><p>Banners publicitários;</p></li>
                            <li><p>Vendas online, mesmo de produtos de criação do autor da página (o UOL tem uma estação específica para este fim, Shopping UOL);</p></li>
                            <li><p>Páginas e arquivos criptografados ou protegidos por senhas (exceto os hospedados no UOL Disco Virtual);</p></li>
                            <li><p>Programas e arquivos que contenham vírus ou qualquer outro código malicioso;</p></li>
                            <li><p>Arquivos que sejam exclusivamente acessados por Websites hospedados fora do UOL;</p></li>
                            <li><p>Defesa ou estímulo às práticas de bulimia e/ou anorexia;</p></li>
                            <li><p>Material que viole qualquer lei municipal, estadual ou federal do Brasil;</p></li>
                            <li><p>Material que configure crime virtual (saiba mais sobre crimes na Internet no endereço: http://denuncia.uol.com.br)</p></li>
                            <li><p>Prática de "flood": envio da mesma mensagem repetidas vezes em um curto espaço de tempo</p></li>
