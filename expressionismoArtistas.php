...
<body>
    ...
    <h4 class="text-center mt-2">Peincipais Artistas do Expressionismo</h4>
    <div class="table table-striped col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 table-bordered artigoexpr mt-2">
              <article class="text-">                    
