    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mt-2">
                <section class="cabecalho-hist-cub">
                    <figure class="text-center">
                        <img src="img/cubismoHist-gd.jpg" class="mx-auto" alt="">
                    </figure>
                </section>
            </div>
        </div> <!-- div row 1 -->
        ...
        <h4 class="text-center">Cubistas Brasileiros</h4>
        <div class="row mt-2 mb-2">    
            <div class="col-lg-3">
                ...
                <div class="col-3 shadow rounded">
                    ...
                    <a href="https://pt.wikipedia.org/wiki/Tarsila_do_Amaral" class="text-center">Tarsila do Amaral</a>
                </div> <!-- div cubistas brasileiros 3 -->
