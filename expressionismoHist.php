...
<head>
    ...
    <title>Expressionismo História</title>
</head>
<body>
...
<h4 class="text-center text-lg-center text-md-center text-sm-center mt-2">História do Expressionismo</h4>
    <article class="artig_homeEXPR text-justify">
...
</div> <!-- fechamento div row container -- >
</div> <!-- fechamento div container container -- >
